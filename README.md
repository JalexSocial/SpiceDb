...
SpiceDb.net was created by Michael Tanczos and has contributions from Pavel Akimov, Mahesh Bailwal, Vin�cius Gajo, and others.  Documentation for SpiceDb.net is in progress and can be found here:
